...
// Create an interface to display a prop in a certain structure
interface DashProps{
...
export const Dashboard = withRouter ( (props:DashProps)  => {
    ...
    return (
        <div className={classes.root}>
          ...
          <Button className={classes.toolbar_button} onClick={handleDialogClickOpen}>Create A New Marvel Character</Button>
